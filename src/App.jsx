        ...
        <section className="hero" id="home">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <a className="primary-action" href="#contact">Start a project <span aria-hidden="true">&#8594;</span></a>
              <a className="secondary-action" href="#about">See how it works <span aria-hidden="true">&#8595;</span></a>
            </div>
